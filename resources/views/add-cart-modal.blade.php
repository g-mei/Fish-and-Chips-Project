...
<div class="container flex justify-center mx-auto hidden modal" id="addToCart#{{$food->id}}">
        ...
        <div class="max-w-xl p-6 bg-white rounded-md" style="z-index: 100">
            ...
            <form class="mt-5" action="{{route('addToCart', ['id' => $food->id])}}" method="POST">
                ...
                <input type="text" name="instructions" id="instructions"
                    class="w-full p-3 mb-4 border border-gray-300 rounded shadow focus:outline-none focus:ring-2 focus:ring-blue-600" maxlength="255">
