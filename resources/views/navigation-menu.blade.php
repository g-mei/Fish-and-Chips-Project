                        ...
                        <div class="hidden sm:flex sm:items-center sm:ml-6">
                            ...
                            <div class="ml-3 relative">
                                <div align="right" width="48">
                                    <a href="{{ route('login') }}" class="text-sm text-gray-700 dark:text-gray-500" :active="request()->routeIs('login')">Log in</a>
                                    
                                    @if (Route::has('register'))
                                        <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500" :active="request()->routeIs('register')">Register</a>
                                    @endif
                                </div>
                            </div>
                        </div>
