        ...
        <table class="bg-gray-100">
            <thead>
                <tr>
                    ...
                    <th scope="col" class="py-3 px-6 text-m font-medium tracking-wider text-left text-gray-800 uppercase">Review title</th>
            ...
            @foreach ($orders as $order)
                <tr class="hover:bg-gray-100">
                    ...
                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap">{{$order->review_title}}</td>
