...
<table class="bg-gray-100 dark:bg-gray-700">
    ...
    @foreach ($packs as $pack)
        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
            <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white"><img src="{{ asset('storage/image/food_packs/'.$food->image) }}" alt="{{$food->image}}" style="width: 200px"></td>
