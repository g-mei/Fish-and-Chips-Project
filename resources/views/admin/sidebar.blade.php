<nav class="absolute z-10 w-48 bg-blue-900 text-white min-h-screen">
    <ul class="mt-10">
        ...
        <li class="hover:bg-blue-400 hover:rounded-m {{Request::is('dashboard/ingredients') ? 'bg-blue-400 rounded-m' : ''}}"><a href="{{route('ingredients')}}" class="block px-4 py-4">Manage Ingredients</a></li>
