<nav class="bg-blue-900 text-white">
    <ul class="flex flex-row justify-center flex-wrap">
        <li class="py-4 hover:bg-blue-400 hover:rounded-m {{Request::is('dashboard', 'dashboard/orders') ? 'bg-blue-400 rounded-m' : ''}} "><a href="{{route('orders')}}" class="px-4 ">Manage Orders</a></li>
        ...
        <li class="py-4 hover:bg-blue-400 hover:rounded-m {{Request::is('dashboard/food') ? 'bg-blue-400 rounded-m' : ''}} "><a href="{{route('food')}}" class="px-4 ">Manage Food</a></li>
        <li class="py-4 hover:bg-blue-400 hover:rounded-m {{Request::is('dashboard/packs') ? 'bg-blue-400 rounded-m' : ''}} "><a href="{{route('packs')}}" class="px-4 ">Manage Packs</a></li>
