    ...
    @foreach ($ingredients as $ingredient)
        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
            ...
            <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">
                <button class="openModal text-blue-700 px-1" aria-label="edit" data-id="{{$ingredient->id}}">Edit</button>
                <button class="openModal text-red-600 px-1" aria-label="delete" data-id="{{$ingredient->id}}">Delete</button>
            </td>
        </tr>
