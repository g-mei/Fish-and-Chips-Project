...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="min-h-screen bg-gray-50" style="margin-top: 5rem">
            <div class="responsive-container justify-center px-4">
                <div class="flex justify-center items-center pr-4 mb-5">
                    <img src="{{asset('img/banner.jpg')}}" width="500">
                </div>
                <div class="container">
                <h1 class="text-xl font-bold mb-4">Who are we?</h1>
